 ...
 * Note that even though the subarrays have the same content, the two subarrays are considered different because 
 * they are in different positions in the original array.
 *
 * 3. Constraints
 * 2 <= nums.length <= 1000
 * -109 <= nums[i] <= 109
