 ...
 * 3) The third customer arrives at time 4, the chef takes his order and starts preparing it at time 8, and finishes 
 * at time 11, so the waiting time of the third customer is 11 - 4 = 7.
 ...
 * 3) The third customer arrives at time 10, the chef takes his order and starts preparing it at time 11, and finishes
 * at time 14, so the waiting time of the third customer is 14 - 10 = 4.
...
public class AverageWaitingTime {
  ...
  public double averageWaitingTime(int[][] customers) {
    ...
    for (int[] customer : customers) {
      idleStartTime = Math.max(idleStartTime, customer[0]);
      totalWaitingTime += customer[1] + idleStartTime - customer[0];
      idleStartTime += customer[1];
    }
